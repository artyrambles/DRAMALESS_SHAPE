...
`mods/DRAMALESS_SHAPE/data/voxel_heights.lua`. Pinning blocks 56/57/60/61 with
...
The mod implements this as `mods/DRAMALESS_SHAPE/lib/Buildings.lua`, driven by
